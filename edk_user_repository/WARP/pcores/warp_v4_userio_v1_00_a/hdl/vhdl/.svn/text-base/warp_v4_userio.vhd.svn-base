------------------------------------------------------------------------------
-- warp_v4_userio.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
entity warp_v4_userio is
  generic
  (
    -- ADD USER GENERICS BELOW THIS LINE ---------------
    C_ADDRESS_0					   : std_logic_vector 			  := X"40";
    C_ADDRESS_1					   : std_logic_vector 			  := X"50";
    C_I2C_DIVIDER			  	   : std_logic_vector 			  := X"40";
  ...
  (
    ...
    IOEx_SDA						   : out std_logic;
    IOEx_SCL						   : out std_logic;
    PB_in					  		   : in std_logic_vector(0 to 3);
    DIPSW_in						   : in std_logic_vector(0 to 3);
...
end entity warp_v4_userio;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of warp_v4_userio is

--  constant ADDRESS0						  : integer				 := C_ADDRESS_0;
--  constant ADDRESS1						  : integer				 := C_ADDRESS_1;
--  constant I2C_DIVIDER					  : integer				 := C_I2C_DIVIDER;
  ...
  component user_logic is
    ...
    (
      ...
      hex_sda						 : out std_logic;
      hex_scl						 : out std_logic;
      pushbuttons					 : in std_logic_vector(0 to 3);
      dipsw							 : in std_logic_vector(0 to 3);
      -- ADD USER PORTS ABOVE THIS LINE ------------------
...
begin
  ...
  USER_LOGIC_I : component user_logic
    ...
    (
      ...
      C_ADDRESS_0					 => C_ADDRESS_0,
      C_ADDRESS_1					 => C_ADDRESS_1,
      C_I2C_DIVIDER					 => C_I2C_DIVIDER,
