...
// Date:              Wed Feb 06 13:11:10 2008 (by Create and Import Peripheral Wizard)
...
(
  // -- ADD USER PORTS BELOW THIS LINE ---------------
	...
	Dac3_cs,
	Dac4_cs,
    Radio1_interpfiltbypass,
    Radio1_decfiltbypass,
	Radio1_SHDN,
	Radio1_TxEn,
	Radio1_RxEn,
	Radio1_RxHP,
	...
	Radio1_TxGain,  
	Radio1_TxStart,
    Radio2_interpfiltbypass,
    Radio2_decfiltbypass,
	Radio2_SHDN,
	Radio2_TxEn,
	Radio2_RxEn,
	Radio2_RxHP,
	...
	Radio2_TxGain,  
	Radio2_TxStart,
    Radio3_interpfiltbypass,
    Radio3_decfiltbypass,
	Radio3_SHDN,
	Radio3_TxEn,
	Radio3_RxEn,
	Radio3_RxHP,
	...
	Radio3_TxGain,
	Radio3_TxStart,
    Radio4_interpfiltbypass,
    Radio4_decfiltbypass,
	Radio4_SHDN,
	Radio4_TxEn,
	Radio4_RxEn,
	Radio4_RxHP,
...
parameter C_NUM_REG                      = 17;
// -- DO NOT EDIT ABOVE THIS LINE --------------------

// -- ADD USER PORTS BELOW THIS LINE -----------------
	output				controller_logic_clk;
	output				spi_clk;
	output				data_out;
	output				Radio1_cs;
	output				Radio2_cs;
    ...
    output				Radio1_interpfiltbypass;
    output				Radio1_decfiltbypass;
	output				Radio1_SHDN;
	output				Radio1_TxEn;
	output				Radio1_RxEn;
	output				Radio1_RxHP;
    ...
    output				Radio2_interpfiltbypass;
    output				Radio2_decfiltbypass;
	output				Radio2_SHDN;
	output				Radio2_TxEn;
	output				Radio2_RxEn;
	output				Radio2_RxHP;
    ...
    output				Radio3_interpfiltbypass;
    output				Radio3_decfiltbypass;
	output				Radio3_SHDN;
	output				Radio3_TxEn;
	output				Radio3_RxEn;
	output				Radio3_RxHP;
    ...
    output				Radio4_interpfiltbypass;
    output				Radio4_decfiltbypass;
	output				Radio4_SHDN;
	output				Radio4_TxEn;
	output				Radio4_RxEn;
	output				Radio4_RxHP;
	...
	output				Radio4_TxStart;// -- ADD USER PORTS ABOVE THIS LINE -----------------
...
//----------------------------------------------------------------------------
  ...
  wire       [0 : 16]                       slv_reg_write_sel;
  wire       [0 : 16]                       slv_reg_read_sel;
  ...
  integer                                   byte_index, bit_index;
	...
	wire [0:7] Radio1_GainRampThresh, Radio1_PAThresh, Radio1_TxEnThresh;
	wire [0:7] Radio2_GainRampThresh, Radio2_PAThresh, Radio2_TxEnThresh;
	wire [0:7] Radio3_GainRampThresh, Radio3_PAThresh, Radio3_TxEnThresh;
	wire [0:7] Radio4_GainRampThresh, Radio4_PAThresh, Radio4_TxEnThresh;

	wire [0:11] Radio1_TxStartThresh, Radio2_TxStartThresh, Radio3_TxStartThresh, Radio4_TxStartThresh;
	...
	// Copy the bus clock to the logic_clk output
	// The bridges use this to latch the signals used here that become top-level I/O
	assign controller_logic_clk = Bus2IP_Clk;
	...
	//slv_reg9[28:31] available for future use

	//Two register bits control the bridge's rate-change filters
	assign Radio1_interpfiltbypass = slv_reg9[14];
	assign Radio1_decfiltbypass = slv_reg9[15];
	...
	assign Radio1_TxStartThresh = slv_reg9[16:27];
	...
	//slv_reg10[28:31] available for future use

	//Two register bits control the bridge's rate-change filters
	assign Radio2_interpfiltbypass = slv_reg10[14];
	assign Radio2_decfiltbypass = slv_reg10[15];
	...
	assign Radio2_TxStartThresh = slv_reg10[16:27];
	...
	//slv_reg11[28:31] available for future use
	
	//Two register bits control the bridge's rate-change filters
	assign Radio3_interpfiltbypass = slv_reg11[14];
	assign Radio3_decfiltbypass = slv_reg11[15];
	
	//Read the user registers for the the delays before each Tx event
	assign Radio3_GainRampThresh = slv_reg15[0:7];
	assign Radio3_PAThresh = slv_reg15[8:15];
	assign Radio3_TxEnThresh = slv_reg15[16:23];
	assign Radio3_TxStartThresh = slv_reg11[16:27];
	...
	//slv_reg12[28:31] available for future use
	
	//Two register bits control the bridge's rate-change filters
	assign Radio4_interpfiltbypass = slv_reg12[14];
	assign Radio4_decfiltbypass = slv_reg12[15];
	
	//Read the user registers for the the delays before each Tx event
	assign Radio4_GainRampThresh = slv_reg16[0:7];
	assign Radio4_PAThresh = slv_reg16[8:15];
	assign Radio4_TxEnThresh = slv_reg16[16:23];
	assign Radio4_TxStartThresh = slv_reg12[16:27];
  ...
  assign
    slv_reg_write_sel = Bus2IP_WrCE[0:16],
    slv_reg_read_sel  = Bus2IP_RdCE[0:16],
  ...
  always @( slv_reg_read_sel or slv_reg0 or slv_reg1 or slv_reg2 or slv_reg3 or slv_reg4 or slv_reg5 or slv_reg6 or slv_reg7 or slv_reg8 or slv_reg9 or slv_reg10 or slv_reg11 or slv_reg12 or slv_reg13 or slv_reg14 or slv_reg15 or slv_reg16 )
