...
## 
## $Header: /devl/xcs/repo/env/Jobs/MDT/sw/Apps/debug/new_xmd/DataFiles/Attic/genace.tcl,v 1.1.2.10.10.1 2008/03/20 18:32:16 boq Exp $
###############################################################################
...
# Production WARP FPGA Board v1.2
set wfv2p(jtag_chain_options) "-configdevice devicenr 1 idcode 0x112ba093 irlength 14 partname XC2VP70"
set wfv2p(jtag_fpga_position) 1
set wfv2p(jtag_devices) "xc2vp70"

# Production WARP FPGA Board v2.2
set wfv4(jtag_chain_options) "-configdevice devicenr 1 idcode 0x01ee4093 irlength 14 partname xc4vfx100"
set wfv4(jtag_fpga_position) 1
set wfv4(jtag_devices) "xc4vfx100"
