...
void WarpRadio_v1_Reset(unsigned int* baseaddress) {
	...
	//Setup the deault TxTiming values for all four radios (all events start immediately)
	RADIO_CONTROLLER_mWriteSlaveReg13((volatile)radio_controller_baseaddr,(unsigned int)((0 << 24) + (0 << 16) + (0 << 8) + 0));
	RADIO_CONTROLLER_mWriteSlaveReg14((volatile)radio_controller_baseaddr,(unsigned int)((0 << 24) + (0 << 16) + (0 << 8) + 0));
	RADIO_CONTROLLER_mWriteSlaveReg15((volatile)radio_controller_baseaddr,(unsigned int)((0 << 24) + (0 << 16) + (0 << 8) + 0));
	RADIO_CONTROLLER_mWriteSlaveReg16((volatile)radio_controller_baseaddr,(unsigned int)((0 << 24) + (0 << 16) + (0 << 8) + 0));

	//Setup the deault TxGainTiming values for all four radios (fastest ramp to max gain)
