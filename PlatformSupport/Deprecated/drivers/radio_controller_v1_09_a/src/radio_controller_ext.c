 ...
 * @param dly_TxEn OPB clock cycles to wait before turning on transmit enable
 * @param dly_TxStart OPB clock cycles to wait before sending enabling data transmission model
 * @param dly_GainRampEn OPB clock cycles to wait before turning on gain ramp cycle
 * @param dly_PowerAmpEn OPB clock cycles to wait before turning on amplifier
 */
