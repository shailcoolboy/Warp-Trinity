...
//All active low signals are inverted here so that levels for all
// control signals are consistent from the software side
//  (RadioN_SHDN, RadioN_24PA and RadioN_5PA)
...
assign  Radio1_LED[0] = slv_reg0[21];
assign  Radio1_LED[1] = slv_reg0[20];
assign  Radio1_LED[2] = slv_reg0[19];
...
assign  Radio2_LED[0] = slv_reg1[21];
assign  Radio2_LED[1] = slv_reg1[20];
assign  Radio2_LED[2] = slv_reg1[19];
...
assign  Radio3_LED[0] = slv_reg2[21];
assign  Radio3_LED[1] = slv_reg2[20];
assign  Radio3_LED[2] = slv_reg2[19];
...
assign  Radio4_LED[0] = slv_reg3[21];
assign  Radio4_LED[1] = slv_reg3[20];
assign  Radio4_LED[2] = slv_reg3[19];
  ...
  always @( slv_reg_read_select or slv_reg0 or slv_reg1 or slv_reg2 or slv_reg3 )
    begin: SLAVE_REG_READ_PROC
      ...
      case ( slv_reg_read_select )
        4'b1000 : slv_ip2bus_data <= {Radio1_RSSI_ADC_D[0:9],
        			      slv_reg0[10],
        			      Radio1_TX_DAC_PLL_LOCK,
        			      Radio1_RSSI_ADC_OTR,
        			      Radio1_DIPSW[0:3],
        ...
        4'b0100 : slv_ip2bus_data <= {Radio2_RSSI_ADC_D[0:9],
        			      slv_reg1[10],
        			      Radio2_TX_DAC_PLL_LOCK,
        			      Radio2_RSSI_ADC_OTR,
        			      Radio2_DIPSW[0:3],
        ...
        4'b0010 : slv_ip2bus_data <= {Radio3_RSSI_ADC_D[0:9],
        			      slv_reg2[10],
        			      Radio3_TX_DAC_PLL_LOCK,
        			      Radio3_RSSI_ADC_OTR,
        			      Radio3_DIPSW[0:3],
        ...
        4'b0001 : slv_ip2bus_data <= {Radio4_RSSI_ADC_D[0:9],
        			      slv_reg3[10],
        			      Radio4_TX_DAC_PLL_LOCK,
        			      Radio4_RSSI_ADC_OTR,
        			      Radio4_DIPSW[0:3],
