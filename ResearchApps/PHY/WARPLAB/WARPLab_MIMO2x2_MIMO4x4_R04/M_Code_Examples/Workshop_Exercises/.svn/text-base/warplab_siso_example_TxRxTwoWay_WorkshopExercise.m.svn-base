...
% Node1_TxDelay:  Number of noise samples per Rx capture in node 2. In [0:2^14]
% Node2_TxDelay: Number of noise samples per Rx capture in node 1. In [0:2^14]
% Node1_TxLength: Length of transmission from node 1. In [0:2^14-1-Node2_TxDelay]
% Node2_TxLength: Length of transmission from node 2. In [0:2^14-1-Node1_TxDelay]
