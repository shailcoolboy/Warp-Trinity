function [LongTrainingStart,Time_Sync] = warplab_findLongTrainingStart_aron(RxData,LongTrainingSymbols_up2,AGC_Set_Address)
...
Time_Sync = 0;   % Resetting the time correlation indicator
...
if(128 ~= abs(peak_2_index-peak_1_index))
    ...
    Time_Sync = 1;   % Turning on the indicator
end
