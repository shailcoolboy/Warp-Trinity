...
for d=1:Num_Data
    ...
    Detect_Mod(3,set+1:set+Num_Pha*32+1) = Detect_Sample(3,d)*exp(t(1:Num_Pha*32+1)*i*2*pi*1.25e6);
    Detect_Mod(4,set+1:set+Num_Pha*32+1) = Detect_Sample(4,d)*exp(t(1:Num_Pha*32+1)*i*2*pi*1.25e6);
end
