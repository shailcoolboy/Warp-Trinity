...
CE_Init_1e5 = CE_Init * 1e5;
% Q_Init = CE_Init * Codebook_Original.'; % Columns correspond to codewords
Q_Init = CE_Init_1e5 * Codebook_Original.'; % Columns correspond to codewords
...
% Quantize channel estimate
CE_NoBF_1e5 = CE_NoBF * 1e5;
% Q_check = CE_NoBF * Codebook_Original.'; % Columns correspond to codewords
Q_check = CE_NoBF_1e5 * Codebook_Original.'; % Columns correspond to codewords
