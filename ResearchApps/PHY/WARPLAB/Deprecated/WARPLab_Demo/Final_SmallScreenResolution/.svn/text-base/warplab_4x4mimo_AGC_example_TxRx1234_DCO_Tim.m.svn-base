% Simple test from all Tx to all Rx. Quick and dirty version, comments may be
% wrong.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
TxData_1 = exp(t*j*2*pi*1.25e6);
%TxData_1 = linspace(0,1,TxLength).*exp(t*j*2*pi*1.25e6);

% Create a signal to transmit from radio 2 
TxData_2 = exp(t*j*2*pi*1.25e6);
%TxData_2 = linspace(0,1,TxLength).*exp(t*j*2*pi*1.25e6); %Signal must be a row vector. The signal can
...
[AGC_GainsSet] = warplab_readAGCGains(udp_RxA);
