...
cla; 
plot(real(Detect_Sample(1,:)),imag(Detect_Sample(1,:)),'k*',...
    'LineWidth',2,...
    'MarkerSize',10);
hold on;
plot(real(Receive_Sample(1,:)),imag(Receive_Sample(1,:)),'go',...
    'LineWidth',2,...
    'MarkerSize',10);
...
cla; 
plot(real(Detect_Sample(2,:)),imag(Detect_Sample(2,:)),'k*',...
    'LineWidth',2,...
    'MarkerSize',10);
hold on;
plot(real(Receive_Sample(2,:)),imag(Receive_Sample(2,:)),'go',...
    'LineWidth',2,...
    'MarkerSize',10);
axis([-2 2 -2 2]); % Set axis ranges.
hold off;
...
cla; 
plot(real(Detect_Sample(3,:)),imag(Detect_Sample(3,:)),'k*',...
    'LineWidth',2,...
    'MarkerSize',10);
hold on;
plot(real(Receive_Sample(3,:)),imag(Receive_Sample(3,:)),'go',...
    'LineWidth',2,...
    'MarkerSize',10);
axis([-2 2 -2 2]); % Set axis ranges.
hold off;
...
cla; 
plot(real(Detect_Sample(4,:)),imag(Detect_Sample(4,:)),'k*',...
    'LineWidth',2,...
    'MarkerSize',10);
hold on;
plot(real(Receive_Sample(4,:)),imag(Receive_Sample(4,:)),'go',...
    'LineWidth',2,...
    'MarkerSize',10);
axis([-2 2 -2 2]); % Set axis ranges.
hold off;
...
set(handles.BER_SD, 'String', num2str(Total_Errors_SD/Total_Bits_SD));
set(handles.cond, 'String', num2str(Condition_Number));
