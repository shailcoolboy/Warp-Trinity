...
M = ConstellationSize; % Size of signal constellation
...
%         Total_Bits_perEbNodB = [220,220,220,220];
        Total_Bits_perEbNodB = nbits; %For Demo
...
%     Node1_Radio3_TxGain_RF = [8,10,12,14]; % Tx RF Gain. In [0:63]
    ...
    Node1_Radio3_TxGain_BB = TxPowerBB_Radio3; % Tx Baseband Gain. In [0:3]
    Node1_Radio3_TxGain_RF = TxPowerRF_Radio3; % Tx RF Gain. In [0:63]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if(0 == SchemeSelect)
    Tx2Rx1_BFvsAlm_BFProc_Demo_v01
...
num2str(Total_Errors_BF_CoherentChannels + Total_Errors_BF_NonCoherentChannels)
set(handles.Error_Beamforming, 'String', num2str(Total_Errors_BF_CoherentChannels + Total_Errors_BF_NonCoherentChannels));
set(handles.Total_Beamforming, 'String', num2str(Total_Bits_BF_CoherentChannels + Total_Bits_BF_NonCoherentChannels));
set(handles.BER_Beamforming, 'String', num2str((Total_Errors_BF_CoherentChannels + Total_Errors_BF_NonCoherentChannels) / (Total_Bits_BF_CoherentChannels + Total_Bits_BF_NonCoherentChannels)));
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if(1==SchemeSelect)
    Tx2Rx1_BFvsAlm_AlmProc_Demo_v01
...
set(handles.Error_Alamouti, 'String', num2str(Total_Errors_Alm));
set(handles.Total_Alamouti, 'String', num2str(Total_Bits_Alm));
set(handles.BER_Alamouti, 'String', num2str(Total_Errors_Alm/Total_Bits_Alm));
