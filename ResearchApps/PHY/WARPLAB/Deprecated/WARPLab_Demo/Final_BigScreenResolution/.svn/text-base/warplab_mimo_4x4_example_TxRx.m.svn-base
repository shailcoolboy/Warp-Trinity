...
Node1_Radio1_TxData =0* exp(t*j*2*pi*1e6); 
...
% is limited to 19 MHz)
% - Lowest frequency component is limited to 30 kHz
Node1_Radio2_TxData = 0*exp(t*j*2*pi*3e6); 
...
% is limited to 19 MHz)
% - Lowest frequency component is limited to 30 kHz
Node1_Radio3_TxData = 0*exp(t*j*2*pi*5e6); 
...
% is limited to 19 MHz)
% - Lowest frequency component is limited to 30 kHz
Node1_Radio4_TxData = 0*exp(t*j*2*pi*7e6); 
...
[Node2_Radio1_RawRxData] = warplab_readSMRO(udp_node2, RADIO1_RXDATA, TxLength+CaptOffset);
...
[Node2_Radio4_RawRxData] = warplab_readSMRO(udp_node2, RADIO4_RXDATA, TxLength+CaptOffset);
