...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Create vectors useful for easy generation of pilots for antennas 1,2,3,4
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ytx_mod_filt_1 = [TrainGuardPilots_1, ytx_mod_filt_up];
ytx_mod_filt_2 = [TrainGuardPilots_2, ytx_mod_filt_up];
ytx_mod_filt_3 = [TrainGuardPilots_3, ytx_mod_filt_up];
ytx_mod_filt_4 = [TrainGuardPilots_4, ytx_mod_filt_up];

TxData_1 = ytx_mod_filt_1;
TxData_2 = ytx_mod_filt_2;
TxData_3 = ytx_mod_filt_3;
TxData_4 = ytx_mod_filt_4;
...
% 
% GainsRF_Init = [1,1,1,1];
% GainsBB_Init = [0,0,0,0];
% 
...
RxData_1_Pilots = RxData_1_Pilots/(ScaleRF_Init(1)*ScaleBB_Init(1));
RxData_2_Pilots = RxData_2_Pilots/(ScaleRF_Init(2)*ScaleBB_Init(2));
RxData_3_Pilots = RxData_3_Pilots/(ScaleRF_Init(3)*ScaleBB_Init(3));
RxData_4_Pilots = RxData_4_Pilots/(ScaleRF_Init(4)*ScaleBB_Init(4));
...
% Amplify RxData
RxData_Init = RxData_Init * 100000;
...
CE_Init = avgrealCE_Init + sqrt(-1)*avgimagCE_Init;
...
RxData_1_Pilots_BF = RxData_1_Pilots_BF/(ScaleRF_BF(1)*ScaleBB_BF(1));
RxData_2_Pilots_BF = RxData_2_Pilots_BF/(ScaleRF_BF(2)*ScaleBB_BF(2));
RxData_3_Pilots_BF = RxData_3_Pilots_BF/(ScaleRF_BF(3)*ScaleBB_BF(3));
RxData_4_Pilots_BF = RxData_4_Pilots_BF/(ScaleRF_BF(4)*ScaleBB_BF(4));

TxData = [TxData_1_Pilots,TxData_2_Pilots,TxData_3_Pilots,TxData_4_Pilots];
RxData_BF = [RxData_1_Pilots_BF,RxData_2_Pilots_BF,RxData_3_Pilots_BF,RxData_4_Pilots_BF];

% Amplify RxData
RxData_BF = RxData_BF * 100000;
...
CE_BF = avgrealCE_BF + sqrt(-1)*avgimagCE_BF;
...
SNR_BFNOT = sum(abs( CE_NoBF * [1/4;1/4;1/4;1/4]).^2);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Scale channel estimate so receiver gains set by the AGC are included in
% the estimates (Include receive gains as part of the channel)
CE_BF_RxGains = diag(ScaleRF_BF.*ScaleBB_BF)*CE_BF;
