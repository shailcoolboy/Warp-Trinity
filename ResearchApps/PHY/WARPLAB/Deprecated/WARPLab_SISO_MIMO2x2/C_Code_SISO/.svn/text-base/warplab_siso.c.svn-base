...
#include "warplab_siso_gateways.h"
#include "EEPROM.h"
...
unsigned char Radio2_TxGain_BB, Radio2_TxGain_RF, Radio2_RxGain_BB, Radio2_RxGain_RF, Radio2_RF_Channel, Radio2_WirelessChan;

unsigned int radios = RADIO1_ADDR | RADIO2_ADDR | RADIO3_ADDR;
		...
		if (bytesReceived > 0) {	// Check for valid packet
			...
			switch(command) {			// Decode on incoming command
				...
				case INITIALIZE:
					...
					warplab_siso_WriteReg_CaptOffset(XPAR_WARPLAB_SISO_OPBW_0_BASEADDR, 0);
					warplab_siso_WriteReg_DoneReading(XPAR_WARPLAB_SISO_OPBW_0_BASEADDR, 0);
					warplab_siso_WriteReg_StartCapture(XPAR_WARPLAB_SISO_OPBW_0_BASEADDR, 0);
					warplab_siso_WriteReg_TxLength(XPAR_WARPLAB_SISO_OPBW_0_BASEADDR, (unsigned int)16383);
					warplab_siso_WriteReg_TransMode(XPAR_WARPLAB_SISO_OPBW_0_BASEADDR, 0);
				...
				case SET_OPTIONS:
					...
					*/
					...
					warplab_siso_WriteReg_CaptOffset(XPAR_WARPLAB_SISO_OPBW_0_BASEADDR, (unsigned int)receivePtr32[2]);
					warplab_siso_WriteReg_TxLength(XPAR_WARPLAB_SISO_OPBW_0_BASEADDR, (unsigned int)receivePtr32[3]);
					warplab_siso_WriteReg_TransMode(XPAR_WARPLAB_SISO_OPBW_0_BASEADDR, (unsigned int)receivePtr32[4]);


					//Extract the config options from the received Ethernet packet
					...
					//Set center frequency for radio #2
					Radio2_WirelessChan = ((unsigned int)receivePtr32[5]);
					WarpRadio_v1_SetCenterFreq2GHz(Radio2_WirelessChan, radio2);
				...
				case RADIO2_TXDATA:
					...
					memcpy
					(
						(unsigned int *)(XPAR_WARPLAB_SISO_OPBW_0_BASEADDR + warplab_siso_SMWO_TxBuff_Radio2_OFFSET + 4*rxArg0),\
				...
				case RADIO2_RXDATA:
					//while(warplab_siso_ReadReg_CaptureDone(XPAR_WARPLAB_SISO_OPBW_0_BASEADDR) == 0) {}

					memcpy
					(
						(unsigned int *)(sendPtr32 + 4), \
						(unsigned int *)(XPAR_WARPLAB_SISO_OPBW_0_BASEADDR + warplab_siso_SMRO_RxBuff_Radio2_OFFSET + 4*rxArg0),\
						1024
					);

					//xil_printf("Read Rx data (offset: %x)\r\n",rxArg0);
					//xil_printf("Copied 1024 bytes from %x\r\n",(XPAR_WARPLAB_SISO_OPBW_0_BASEADDR + warplab_siso_SMRO_RxBuff_Radio2_OFFSET + rxArg0));
				...
				case RX_DONECHECK:
					...
					if(warplab_siso_ReadReg_CaptureDone(XPAR_WARPLAB_SISO_OPBW_0_BASEADDR) == 0)
						sendPtr32[3] = 0;
					else
						sendPtr32[3] = 1;
				...
				case RADIO2_RSSIDATA:
					...
					(
						(unsigned int *)(sendPtr32 + 4), \
						(unsigned int *)(XPAR_WARPLAB_SISO_OPBW_0_BASEADDR + warplab_siso_SMRO_RSSIBuff_Radio2_OFFSET + 4*rxArg0),\
						1024
					);

					//xil_printf("Read RSSI data (offset: %x)\r\n",rxArg0);
					//xil_printf("Copied 1024 bytes from %x\r\n",(XPAR_WARPLAB_SISO_OPBW_0_BASEADDR + warplab_siso_SMRO_RSSIBuff_Radio2_OFFSET + 4*rxArg0));
				...
				case RX_DONEREADING:
					warplab_siso_WriteReg_DoneReading(XPAR_WARPLAB_SISO_OPBW_0_BASEADDR, 1);
					warplab_siso_WriteReg_DoneReading(XPAR_WARPLAB_SISO_OPBW_0_BASEADDR, 0);
				...
				case RX_START:
					...
					if(waitForSync() == 0)
					{
						warplab_siso_WriteReg_StartCapture(XPAR_WARPLAB_SISO_OPBW_0_BASEADDR, 1);
						warplab_siso_WriteReg_StartCapture(XPAR_WARPLAB_SISO_OPBW_0_BASEADDR, 0);
				...
				case TX_START:
					...
					if(waitForSync() == 0)
					{
						warplab_siso_WriteReg_StartTx(XPAR_WARPLAB_SISO_OPBW_0_BASEADDR, 1);
						warplab_siso_WriteReg_StartTx(XPAR_WARPLAB_SISO_OPBW_0_BASEADDR, 0);
				...
				case TX_STOP:
					...
					warplab_siso_WriteReg_StopTx(XPAR_WARPLAB_SISO_OPBW_0_BASEADDR, 1);
					warplab_siso_WriteReg_StopTx(XPAR_WARPLAB_SISO_OPBW_0_BASEADDR, 0);
