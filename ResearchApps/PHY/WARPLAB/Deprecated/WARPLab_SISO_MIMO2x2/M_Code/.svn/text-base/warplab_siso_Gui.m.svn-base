function varargout = warplab_siso_Gui(varargin)
% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @warplab_siso_Gui_OpeningFcn, ...
                   'gui_OutputFcn',  @warplab_siso_Gui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before warplab_siso_Gui is made visible.
function warplab_siso_Gui_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to warplab_siso_Gui (see VARARGIN)
% Choose default command line output for warplab_siso_Gui
...
function varargout = warplab_siso_Gui_OutputFcn(hObject, eventdata, handles) 
...
spectrum=10*log10(abs(fftshift(fft(rxData(warplab_sisoGUI.CaptOffset:end),2^14))));
plot(freq_ticks(2^12:3*2^12),spectrum(2^12:3*2^12));
...
warplab_sisoGUI.optionsVector = [warplab_sisoGUI.CaptOffset warplab_sisoGUI.TxLength-1 0  warplab_sisoGUI.CarrierChannel (warplab_sisoGUI.RxGainBB + warplab_sisoGUI.RxGainRF*2^16) (warplab_sisoGUI.TxGainRF + warplab_sisoGUI.TxGainBB*2^16)];
