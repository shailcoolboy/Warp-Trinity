...
[Node1_Radio2_to_Node2_Radio2_RawRxData] = warplab_readSMRO(udp_node2, RADIO2_RXDATA, TxLength+CaptOffset);
% Read back the received samples from radio 3
[Node1_Radio2_to_Node2_Radio3_RawRxData] = warplab_readSMRO(udp_node2, RADIO3_RXDATA, TxLength+CaptOffset);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Read back the received samples from radio 2
[Node1_Radio3_to_Node2_Radio2_RawRxData] = warplab_readSMRO(udp_node2, RADIO2_RXDATA, TxLength+CaptOffset);
% Read back the received samples from radio 3
[Node1_Radio3_to_Node2_Radio3_RawRxData] = warplab_readSMRO(udp_node2, RADIO3_RXDATA, TxLength+CaptOffset);
% Process the received samples to obtain meaningful data
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Tx2_Rx2_RxData = Node1_Radio2_to_Node2_Radio2_RxData(CaptOffset+1:end);
Tx2_Rx3_RxData = Node1_Radio2_to_Node2_Radio3_RxData(CaptOffset+1:end);
Tx3_Rx2_RxData = Node1_Radio3_to_Node2_Radio2_RxData(CaptOffset+1:end);
Tx3_Rx3_RxData = Node1_Radio3_to_Node2_Radio3_RxData(CaptOffset+1:end);
