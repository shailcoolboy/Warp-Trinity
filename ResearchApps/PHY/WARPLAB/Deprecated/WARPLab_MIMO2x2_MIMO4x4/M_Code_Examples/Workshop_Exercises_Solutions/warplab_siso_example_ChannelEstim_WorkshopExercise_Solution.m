...
% Hints: You can use Matlab's 'abs' function, the transmitted data is stored
% in vector 'Node1_Radio2_TxData', and the received data is stored in vector
% 'Node2_Radio2_RxData'
...
% Hints: You can use Matlab's 'angle' function, the transmitted data is stored
% in vector 'Node1_Radio2_TxData', and the received data is stored in vector
% 'Node2_Radio2_RxData'.
