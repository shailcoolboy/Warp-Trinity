...
Node1_CaptOffset = 1000; % Number of noise samples per Rx capture in node 1. In [0:2^14]
Node2_CaptOffset = 2000; % Number of noise samples per Rx capture in node 2. In [0:2^14]
Node1_TxLength = 2^14-1-2000; % Length of transmission from node 1. In [0:2^14-1-Node2_CaptOffset]
Node2_TxLength = 2^14-1-1000; % Length of transmission from node 2. In [0:2^14-1-Node1_CaptOffset]
CarrierChannel = 8; % Channel in the 2.4 GHz band. In [1:14]
