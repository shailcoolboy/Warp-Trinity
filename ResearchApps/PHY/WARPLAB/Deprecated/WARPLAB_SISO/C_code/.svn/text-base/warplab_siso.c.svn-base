...
unsigned int radios = RADIO1_ADDR | RADIO2_ADDR;
			...
			switch(command) {			// Decode on incoming command
				...
				case SET_OPTIONS:
					...
					*/
					...
					Radio2_TxGain_BB = (((unsigned int)receivePtr32[5])>>16)&0x3;
					Radio2_TxGain_RF = ((unsigned int)receivePtr32[5])&0x3F;
					Radio2_RxGain_RF = (((unsigned int)receivePtr32[4])>>16)&0x3;
					Radio2_RxGain_BB = ((unsigned int)receivePtr32[4])&0x1F;
					Radio2_WirelessChan = ((unsigned int)receivePtr32[6]);
