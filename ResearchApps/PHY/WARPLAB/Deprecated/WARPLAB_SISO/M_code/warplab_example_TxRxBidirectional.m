%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Transmitting and Receiving Data using Warplab to establish a
% bidirectional link
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This MATLAB script uses Warplab to establish a bidirectional link
% between two nodes. First node A will transmit to node B and then node B
% will transmit to node A.
...
TxDataBA = linspace(0,1,TxLength).*exp(t*j*2*pi*1e6); 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Enable transmission
warplab_enableTx(udp_nodeA);

% Enable reception
warplab_enableRx(udp_nodeB);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Enable transmission
warplab_enableTx(udp_nodeB);

% Enable reception
warplab_enableRx(udp_nodeA);
