...
% name of the script (enter warplab_mimo_2x2_example_TxRx_WorkshopExercise
...
% TxDelay: Number of noise samples per Rx capture. In [0:2^14]
% TxLength: Length of transmission. In [0:2^14-1-TxDelay]
...
% To send the RADIO2_TXEN and RADIO3_TXEN commands in one call of the 
% 'warplab_sendCmd' function the second argument of the 'warplab_sendCmd'
% function can be a vector of the commands: [RADIO2_TXEN, RADIO3_TXEN]
...
% the 'warplab_sendCmd' function. The 'warplab_sendCmd' function has been 
% used in previous exercises. To send the
...
% The id for radio 2 Rx buffer is 'RADIO2_RXDATA'.
...
% The id for radio 3 Rx buffer is 'RADIO3_RXDATA'.
