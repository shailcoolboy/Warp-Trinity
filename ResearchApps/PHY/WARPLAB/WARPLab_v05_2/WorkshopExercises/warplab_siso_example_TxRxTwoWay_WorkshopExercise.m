...
% name of the script (enter warplab_siso_example_TxRxTwoWay_WorkshopExercise
...
% Node1_TxDelay:  Number of noise samples per Rx capture in node 1. In [0:2^14]
% Node2_TxDelay: Number of noise samples per Rx capture in node 2. In [0:2^14]
% Node1_TxLength: Length of transmission from node 2. In [0:2^14-1-Node2_TxDelay]
% Node2_TxLength: Length of transmission from node 1. In [0:2^14-1-Node1_TxDelay]
% CarrierChannel: Channel in the 2.4 GHz band. In [1:14]
% Node1_Radio2_TxGain_BB: Tx Baseband Gain Node1 Radio2. In [0:3]
% Node1_Radio2_TxGain_RF: Tx RF Gain Node1 Radio2. In [0:63]
% Node1_Radio2_RxGain_BB: Rx Baseband Gain Node1 Radio2. In [0:31]
% Node1_Radio2_RxGain_RF: Rx RF Gain Node1 Radio2. In [1:3]
% Node2_Radio2_TxGain_BB: Tx Baseband Gain Node2 Radio2. In [0:3]
% Node2_Radio2_TxGain_RF: Tx RF Gain Node2 Radio2. In [0:63] 
% Node2_Radio2_RxGain_BB: Rx Baseband Gain Node2 Radio2. In [0:31]
% Node2_Radio2_RxGain_RF: Rx RF Gain Node2 Radio2. In [1:3]  
...
% 'warplab_writeSMWO' function has been used in previous exercises.
...
% The 'warplab_sendCmd' function has been used in previous exercises.
