...
//	CalibrateTxDCO(RADIO1_ADDR);
//	CalibrateTxDCO(RADIO2_ADDR);
//	CalibrateTxDCO(RADIO3_ADDR);
//	CalibrateTxDCO(RADIO4_ADDR);
		...
		if (bytesReceived > 0) {	// Check for valid packet
			...
			switch(command) {			// Decode on incoming command
				...
				case INITIALIZE:
					...
					warplab_mimo_4x4_WriteReg_TxDelay(XPAR_WARPLAB_MIMO_4X4_OPBW_0_BASEADDR, 0);
					...
					warplab_mimo_4x4_WriteReg_TransMode(XPAR_WARPLAB_MIMO_4X4_OPBW_0_BASEADDR, 0);
					...
					warplab_mimo_4x4_WriteReg_DebugRx1Buffers(XPAR_WARPLAB_MIMO_4X4_OPBW_0_BASEADDR, 0);
					warplab_mimo_4x4_WriteReg_DebugRx2Buffers(XPAR_WARPLAB_MIMO_4X4_OPBW_0_BASEADDR, 0);
					warplab_mimo_4x4_WriteReg_DebugRx3Buffers(XPAR_WARPLAB_MIMO_4X4_OPBW_0_BASEADDR, 0);
					warplab_mimo_4x4_WriteReg_DebugRx4Buffers(XPAR_WARPLAB_MIMO_4X4_OPBW_0_BASEADDR, 0);
					warplab_mimo_4x4_AGC_WriteReg_RADIO1_AGC_EN(XPAR_WARPLAB_MIMO_4X4_AGC_PLBW_0_BASEADDR,0);
					...
					warplab_mimo_4x4_AGC_WriteReg_RADIO4_AGC_EN(XPAR_WARPLAB_MIMO_4X4_AGC_PLBW_0_BASEADDR,0);
					warplab_mimo_4x4_AGC_WriteReg_AGC_TRIGGER_DELAY(XPAR_WARPLAB_MIMO_4X4_AGC_PLBW_0_BASEADDR,(unsigned int)50);
					warplab_mimo_4x4_WriteReg_MGC_AGC_SEL(XPAR_WARPLAB_MIMO_4X4_OPBW_0_BASEADDR, 0);// Select MGC by default
				...
				case TX_DELAY:
					...
					if(0 == ReadWrite)
					{
						...
						sendPtr32[3] = warplab_mimo_4x4_ReadReg_TxDelay(XPAR_WARPLAB_MIMO_4X4_OPBW_0_BASEADDR);
					...
					if(1 == ReadWrite)
					{
						...
						warplab_mimo_4x4_WriteReg_TxDelay(XPAR_WARPLAB_MIMO_4X4_OPBW_0_BASEADDR, (unsigned int)receivePtr32[3] > 16383 ? 16383 : (unsigned int)receivePtr32[3]);
				...
				case TX_LENGTH:
					...
					if(1 == ReadWrite)
					{
						...
						warplab_mimo_4x4_WriteReg_TxLength(XPAR_WARPLAB_MIMO_4X4_OPBW_0_BASEADDR, (unsigned int)receivePtr32[3] > 16383 ? 16383 : (unsigned int)receivePtr32[3]);
				...
				case TX_MODE:
					...
					if(0 == ReadWrite)
					{
						...
						sendPtr32[3] = warplab_mimo_4x4_ReadReg_TransMode(XPAR_WARPLAB_MIMO_4X4_OPBW_0_BASEADDR);

						xilsock_sendto(sock, sendBuffer, 16, (struct sockaddr *)&addr, alen);
					}
					if(1 == ReadWrite)
					{
						warplab_mimo_4x4_WriteReg_TransMode(XPAR_WARPLAB_MIMO_4X4_OPBW_0_BASEADDR, (unsigned int)receivePtr32[3]);
						sendACK(packetNo, command);
					}
				break;
				...
				case RX1BUFFERS_DEBUG:
				   ReadWrite = (unsigned int)receivePtr32[2];
					if(0 == ReadWrite)
					{
						...
						sendPtr32[3] = warplab_mimo_4x4_ReadReg_DebugRx1Buffers(XPAR_WARPLAB_MIMO_4X4_OPBW_0_BASEADDR);

						xilsock_sendto(sock, sendBuffer, 16, (struct sockaddr *)&addr, alen);
					}
					if(1 == ReadWrite)
					{
						warplab_mimo_4x4_WriteReg_DebugRx1Buffers(XPAR_WARPLAB_MIMO_4X4_OPBW_0_BASEADDR, (unsigned int)receivePtr32[3]);
						sendACK(packetNo, command);
					}
				break;
				...
				case RX2BUFFERS_DEBUG:
				   ReadWrite = (unsigned int)receivePtr32[2];
					if(0 == ReadWrite)
					{
						...
						sendPtr32[3] = warplab_mimo_4x4_ReadReg_DebugRx2Buffers(XPAR_WARPLAB_MIMO_4X4_OPBW_0_BASEADDR);

						xilsock_sendto(sock, sendBuffer, 16, (struct sockaddr *)&addr, alen);
					}
					if(1 == ReadWrite)
					{
						warplab_mimo_4x4_WriteReg_DebugRx2Buffers(XPAR_WARPLAB_MIMO_4X4_OPBW_0_BASEADDR, (unsigned int)receivePtr32[3]);
						sendACK(packetNo, command);
					}
				break;
				...
				case RX3BUFFERS_DEBUG:
					...
					if(0 == ReadWrite)
					{
						...
						sendPtr32[3] = warplab_mimo_4x4_ReadReg_DebugRx3Buffers(XPAR_WARPLAB_MIMO_4X4_OPBW_0_BASEADDR);

						xilsock_sendto(sock, sendBuffer, 16, (struct sockaddr *)&addr, alen);
					}
					if(1 == ReadWrite)
					{
						warplab_mimo_4x4_WriteReg_DebugRx3Buffers(XPAR_WARPLAB_MIMO_4X4_OPBW_0_BASEADDR, (unsigned int)receivePtr32[3]);
						sendACK(packetNo, command);
					}
				break;
				...
				case RX4BUFFERS_DEBUG:
					...
					if(0 == ReadWrite)
					{
						...
						sendPtr32[3] = warplab_mimo_4x4_ReadReg_DebugRx4Buffers(XPAR_WARPLAB_MIMO_4X4_OPBW_0_BASEADDR);

						xilsock_sendto(sock, sendBuffer, 16, (struct sockaddr *)&addr, alen);
					}
					if(1 == ReadWrite)
					{
						warplab_mimo_4x4_WriteReg_DebugRx4Buffers(XPAR_WARPLAB_MIMO_4X4_OPBW_0_BASEADDR, (unsigned int)receivePtr32[3]);
						sendACK(packetNo, command);
					}
				break;
				...
				case MGC_AGC_SEL:
					...
					//if(1 == ReadWrite)
					//{
						warplab_mimo_4x4_WriteReg_MGC_AGC_SEL(XPAR_WARPLAB_MIMO_4X4_OPBW_0_BASEADDR, MGC_AGC_Sel_Variable);
				...
				case RADIO1_RXEN:
					...
					if(1 == MGC_AGC_Sel_Variable)
					{
						...
						warplab_mimo_4x4_AGC_WriteReg_RADIO1_AGC_EN(XPAR_WARPLAB_MIMO_4X4_AGC_PLBW_0_BASEADDR,1);
					}
				...
				case RADIO4_RXEN:
					...
					{
						//Enable this radio's AGC if user has set AGC Mode
						warplab_mimo_4x4_AGC_WriteReg_RADIO4_AGC_EN(XPAR_WARPLAB_MIMO_4X4_AGC_PLBW_0_BASEADDR,1);
					}
				...
				case RADIO1_TXDATA:
					memcpy
					(
						(unsigned int *)(XPAR_WARPLAB_MIMO_4X4_PLBW_0_MEMMAP_TXBUFF_RADIO1 + 4*rxArg0),\
						(unsigned int *)(receivePtr32 + 3),\
						(bytesReceived-12)
					);
					sendACK(packetNo, command);
				...
				case RADIO2_TXDATA:
					...
					*/
					memcpy
					(
						(unsigned int *)(XPAR_WARPLAB_MIMO_4X4_PLBW_0_MEMMAP_TXBUFF_RADIO2 + 4*rxArg0),\
						(unsigned int *)(receivePtr32 + 3),\
						(bytesReceived-12)
					);
					sendACK(packetNo, command);
				...
				case RADIO3_TXDATA:
					...
					*/
					memcpy
					(
						(unsigned int *)(XPAR_WARPLAB_MIMO_4X4_PLBW_0_MEMMAP_TXBUFF_RADIO3 + 4*rxArg0),\
						(unsigned int *)(receivePtr32 + 3),\
						(bytesReceived-12)
					);
					sendACK(packetNo, command);
				...
				case RADIO4_TXDATA:
					memcpy
					(
						(unsigned int *)(XPAR_WARPLAB_MIMO_4X4_PLBW_0_MEMMAP_TXBUFF_RADIO4 + 4*rxArg0),\
						(unsigned int *)(receivePtr32 + 3),\
						(bytesReceived-12)
					);
					sendACK(packetNo, command);
				...
				case RADIO1_RXDATA:
					...
					(
						...
						(unsigned int *)(XPAR_WARPLAB_MIMO_4X4_PLBW_0_MEMMAP_RXBUFF_RADIO1 + 4*rxArg0),\
						1024
					);
				...
				case RADIO2_RXDATA:
					...
					*/
					...
					(
						(unsigned int *)(sendPtr32 + 4), \
						(unsigned int *)(XPAR_WARPLAB_MIMO_4X4_PLBW_0_MEMMAP_RXBUFF_RADIO2 + 4*rxArg0),\
						1024
					);
				...
				case RADIO3_RXDATA:
					...
					*/
					...
					(
						(unsigned int *)(sendPtr32 + 4), \
						(unsigned int *)(XPAR_WARPLAB_MIMO_4X4_PLBW_0_MEMMAP_RXBUFF_RADIO3 + 4*rxArg0),\
						1024
					);
				...
				case RADIO4_RXDATA:
					...
					(
						(unsigned int *)(sendPtr32 + 4), \
						(unsigned int *)(XPAR_WARPLAB_MIMO_4X4_PLBW_0_MEMMAP_RXBUFF_RADIO4 + 4*rxArg0),\
						1024
					);
				...
				case TX_STOP:
					...
					warplab_mimo_4x4_WriteReg_StopTx(XPAR_WARPLAB_MIMO_4X4_OPBW_0_BASEADDR, 1);
					warplab_mimo_4x4_WriteReg_StopTx(XPAR_WARPLAB_MIMO_4X4_OPBW_0_BASEADDR, 0);
				...
				case READ_AGC_DONE_ADDR:
					...
					sendPtr32[3] = warplab_mimo_4x4_ReadReg_AGCDoneAddr(XPAR_WARPLAB_MIMO_4X4_OPBW_0_BASEADDR);
				...
				case READ_RADIO1AGCDONERSSI:
					...
					sendPtr32[3] = warplab_mimo_4x4_ReadReg_Radio1AGCDoneRSSI(XPAR_WARPLAB_MIMO_4X4_OPBW_0_BASEADDR);
				...
				case READ_RADIO2AGCDONERSSI:
					...
					sendPtr32[3] = warplab_mimo_4x4_ReadReg_Radio2AGCDoneRSSI(XPAR_WARPLAB_MIMO_4X4_OPBW_0_BASEADDR);
				...
				case READ_RADIO3AGCDONERSSI:
					...
					sendPtr32[3] = warplab_mimo_4x4_ReadReg_Radio3AGCDoneRSSI(XPAR_WARPLAB_MIMO_4X4_OPBW_0_BASEADDR);
				...
				case READ_RADIO4AGCDONERSSI:
					...
					sendPtr32[3] = warplab_mimo_4x4_ReadReg_Radio4AGCDoneRSSI(XPAR_WARPLAB_MIMO_4X4_OPBW_0_BASEADDR);
				...
				case SET_AGC_DCO_EN_DIS:
					...
					warplab_mimo_4x4_WriteReg_DCO_EN_SEL(XPAR_WARPLAB_MIMO_4X4_OPBW_0_BASEADDR, agc_dco_state);
...
// Commented out old TxDCO Calibration code see new code below
