%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Continuous transmission for calibration of emulator input power
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
TxLength = 2^14-1-0; % Length of transmission. In [0:2^14-1-TxDelay]
...
Node2_Radio3_RxGain_RF = 2; % Rx RF Gain. In [1:3]  
...
% load AlamoutiTxData;
% load AlamoutiTxData_QPSK;

% load AlamoutiTxData_16QAM_17May2009;
load AlamoutiTxData_QPSK_17May2009;
...
% Node1_Radio2_TxData = TxData_2_Alamouti;
Node1_Radio2_TxData = TxData_2;

%%%%%%%
% % Calibrate with sweeping signal
% t = 0:(1/40e6):TxLength/40e6 - 1/40e6; % Create time vector.
% f = 0.5e6:(10e6/TxLength):10.5e6 - 1; % Create frequency vector (Sweeps from 
...
% Node1_Radio3_TxData = TxData_3_Alamouti;
Node1_Radio3_TxData = TxData_3;
...
%[Node2_Radio2_RawRSSIData] = warplab_readSMRO(udp_node2, RADIO2_RSSIDATA, floor((TxLength+TxDelay)/8));
% Read stored RSSI data from radio 3
%[Node2_Radio3_RawRSSIData] = warplab_readSMRO(udp_node2, RADIO3_RSSIDATA, floor((TxLength+TxDelay)/8));
