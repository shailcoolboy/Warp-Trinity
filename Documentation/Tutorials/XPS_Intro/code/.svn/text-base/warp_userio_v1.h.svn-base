...
*  Xilinx EDK 10.1.02 (or later)
*  Base System Builder
*  WARP FPGA Board v1.2 XBD svn rev 925 (or later)
*************************************************************/
...
#define USERIO_MAP_DISPR(x) ( (unsigned int)(USERIO_MASK_DISPR & ( (unsigned int)sevenSegmentMap((unsigned char)x) << USERIO_OFFSET_DISPR)) )
#define USERIO_MAP_DISPL(x) ( (unsigned int)(USERIO_MASK_DISPL & ( (unsigned int)sevenSegmentMap((unsigned char)x) << USERIO_OFFSET_DISPL)) )
